...
var _filterCmsJs = require("./modules/filterCms.js");
...
var _homePreloadJs = require("./modules/homePreload.js");
...
document.addEventListener("DOMContentLoaded", ()=>{
    ...
    (0, _textAnimationsJs.textHighlight)();
    (0, _navbarWithModal.animateNav)();
    (0, _navbarWithModal.mobileHamburger)();
    (0, _docSidenavJs.initDocSideNav)();
    (0, _navbarWithModal.industryHover)();
    (0, _homePreloadJs.playImageSequence)();
...
},{"./modules/animations.js":"3cqfm","./modules/navbarWithModal":"iEjuF","./modules/textAnimations.js":"cs5hL","./modules/faqs.js":"9jBJ5","./modules/filterCms.js":"k6dB9","./modules/cmsText.js":"6Iz6U","./modules/load.js":"4plDV","./modules/docSidenav.js":"5k1uu","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./modules/homePreload.js":"biNh4"}],"3cqfm":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
parcelHelpers.defineInteropFlag(exports);
// this is a test
parcelHelpers.export(exports, "initFAQAccordion", ()=>initFAQAccordion);
var _gsap = require("gsap");
var _gsapDefault = parcelHelpers.interopDefault(_gsap);
function initFAQAccordion() {
    let groups = (0, _gsapDefault.default).utils.toArray(".faq-menu");
    let menus = (0, _gsapDefault.default).utils.toArray(".faq-item");
    let menuToggles = [];
    ...
    function createAnimation(menu) {
        ...
        (0, _gsapDefault.default).set(box, {
            height: "auto"
        });
        (0, _gsapDefault.default).set(questionText, {
            marginLeft: "0vw"
        });
        let timeline = (0, _gsapDefault.default).timeline({
            paused: true
        }).from(box, {
            height: 0,
            duration: 0.5,
...
},{"gsap":"fPSuC","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"k6dB9":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "filterCollection", ()=>filterCollection);
var _gsap = require("gsap");
var _gsapDefault = parcelHelpers.interopDefault(_gsap);
function filterCollection() {
    ...
    function filterItems() {
        ...
        cmsItems.forEach((item)=>{
            ...
            if (matchesIndustry && matchesTemperature && matchesPressure) (0, _gsapDefault.default).to(item, {
                opacity: 1,
                display: "block",
                duration: 0.3
            });
            else (0, _gsapDefault.default).to(item, {
                opacity: 0,
                display: "none",
                duration: 0.3
            });
...
},{"gsap":"fPSuC","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"6Iz6U":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "initPageFadeIn", ()=>initPageFadeIn);
var _gsap = require("gsap");
var _gsapDefault = parcelHelpers.interopDefault(_gsap);
const initPageFadeIn = ()=>{
    ...
    (0, _gsapDefault.default).timeline()// .fromTo(
    //     heroElements,
...
},{"gsap":"fPSuC","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"5k1uu":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
// Initialize the side navigation
parcelHelpers.export(exports, "initDocSideNav", ()=>initDocSideNav);
var _gsap = require("gsap");
var _gsapDefault = parcelHelpers.interopDefault(_gsap);
function initDocSideNav() {
    const menus = (0, _gsapDefault.default).utils.toArray(".ep-doc-dropdown");
    let menuToggles = [];
...
},{"gsap":"fPSuC","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"biNh4":[function(require,module,exports,__globalThis) {
...
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "playImageSequence", ()=>playImageSequence);
function playImageSequence() {
    ...
    const renderFrame = ()=>{
        if (currentFrame <= images.length) {
            ...
            if (image.complete) drawFrame(image);
            currentFrame++;
            setTimeout(renderFrame, 1000 / fps); // Adjust playback for 60 FPS
        } else animationRunning = false; // Animation has ended
    };
